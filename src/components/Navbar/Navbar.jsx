    ...
    <>
      <div className='bg-blue-600 text-blue-300 sticky top-0 z-20'>
        <div className='w-4/5 md:w-3/5 mx-auto h-20 flex justify-between items-center'>
          <div className='rounded-full h-8 w-8 border border-blue-300 flex justify-center items-center hover:text-white hover:border-white transition-colors cursor-pointer'>sa</div>
      ...
      <div className={`w-4/5 md:w-3/5 mx-auto transition-all`} onClick={() => setMenu(false)}>
        {children}
        <a href="#top">
